#!/bin/bash
params="../coadd.fits -CHECKIMAGE_TYPE NONE -PARAMETERS_NAME ../../../photometry.param -FILTER_NAME ../../../filters/gauss_3.0_5x5.conv -WEIGHT_IMAGE ../coadd.weight.fits -FLAG_IMAGE ../flag.fits"

run_se() {
  sex -c ../../../stack.sex $params -CATALOG_NAME "$1.fits" "${@:2}"
...
run_se filt_gaus2 -FILTER_NAME ../../../filters/gauss_2.0_3x3.conv  -DETECT_THRESH 2
run_se filt_gaus3 -FILTER_NAME ../../../filters/gauss_4.0_7x7.conv  -DETECT_THRESH 2
